  ...
  <div class="suggestion-card">
    ...
    <div class="card-footer">
      <div class="card-timestamp">
        suggestion crée le {{ timestamp(suggestion.created_at) }}
      </div>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        newSuggestion: {
          category: "back",
          description: "Présentation sur la sécurité par Samy",
          kata_leader: "samy",
          name: "Sécurité",
          planned_date: "2019-06-07",
          updated_at: "2019-06-05T00:14:42.235Z",
        },
      }
    },
    props: {
