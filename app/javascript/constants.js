...
const users = [
  ...
  { firstName: 'Ariane', photo: 'ari.jpeg', businessUnits: [produitBu] },
  ...
  { firstName: 'Caroline', photo: 'caroline.jpeg', businessUnits: [produitBu] },
  { firstName: 'Celestin', photo: 'celo.jpeg', businessUnits: [techBu] },
  { firstName: 'Charlotte', photo: 'charlotte.jpeg', businessUnits: [sdrBu, salesBu] },
  { firstName: 'Chloé', photo: 'chloe.jpeg', businessUnits: [sdrBu, salesBu] },
  ...
  { firstName: 'Eliott', photo: 'eliott.jpeg', businessUnits: [marketingBu] },
  ...
  { firstName: 'Jubeo', photo: 'jubeo.jpeg', businessUnits: [produitBu] },
  ...
  { firstName: 'Quitterie', photo: 'kit.jpeg', businessUnits: [associesBu, produitBu, marketingBu, opsBu] },
  ...
  { firstName: 'Emmanuelle', photo: 'manue.jpeg', businessUnits: [associesBu, opsBu, grandsComptesBu, coachBu, rhBu, financeBu] },
  { firstName: 'Marie', photo: 'marie.jpeg', businessUnits: [salesBu] },
  { firstName: 'Mathilde', photo: 'mathilde.jpeg', businessUnits: [salesBu] },
  { firstName: 'Minéa', photo: 'mims.jpeg', businessUnits: [salesBu, teamLeadersBu] },
  { firstName: 'Nicolas', photo: 'nico.jpeg', businessUnits: [salesBu] },
  { firstName: 'Nisrine', photo: 'niss.jpeg', businessUnits: [salesBu, teamLeadersBu] },
  { firstName: 'Pénélope', photo: 'penelope.jpeg', businessUnits: [financeBu] },
  { firstName: 'Raphaël', photo: 'raph.jpeg', businessUnits: [salesBu] },
  { firstName: 'Samy', photo: 'samy.jpeg', businessUnits: [associesBu, techBu] },
  { firstName: 'Seb', photo: 'seb.jpeg', businessUnits: [techBu] },
  { firstName: 'Thibault', photo: 'thib.jpeg', businessUnits: [associesBu, salesBu] },
  { firstName: 'Thomas', photo: 'toto.jpeg', businessUnits: [salesBu] },
  { firstName: 'Tristan', photo: 'tristan.jpeg', businessUnits: [salesBu] },
  { firstName: 'Victor C', photo: 'victor_c.jpeg', businessUnits: [opsBu] },
